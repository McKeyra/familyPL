...
export default function Calendar() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-lg mx-auto">
      ...
      {/* Add Event Modal - Centered with keyboard awareness */}
      <Modal
        isOpen={showAddEvent}
      ...
      >
          ...
          <div className="flex gap-2">
            {[
              ...
              <button
                ...
                className={`
                  flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-sm font-medium transition-all min-h-[44px]
          ...
          <div className="flex flex-wrap gap-2">
            {quickCategories.map((cat) => (
              <button
                ...
                className={`
                  flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm transition-all min-h-[40px]
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 rounded-xl text-sm bg-slate-100 text-slate-500 hover:bg-slate-200 min-h-[40px]"
            >
              More
        ...
        <div className="mb-4">
          <button
            ...
            className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-700 min-h-[36px]"
          >
              ...
              >
                ...
                <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent focus:outline-none text-sm text-slate-700 min-h-[36px]"
